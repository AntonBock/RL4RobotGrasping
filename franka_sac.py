...
if checkpoint:
    networks_sac["policy"].load("./runs/million/checkpoints/1000000_policy.pt") 
else:
...
cfg_sac["random_timesteps"] = 20000
cfg_sac["learning_starts"] = 20000
...
agent = SAC(networks=networks_sac,
            memory=memory, 
            cfg=cfg_sac, 
